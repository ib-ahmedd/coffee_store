...
function About() {
  return (
    <section className="flex flex-col md:flex-row bg-[#fcf6ef]  w-full items-end md:h-screen">
      <div className="w-full h-full flex flex-col p-8 lg:p-40 box-border md:w-1/2">
        <h2 className="font-bold font-yeseva text-4xl z-10 text-orange my-4 lg:text-8xl sm:text-6xl">
          About
        </h2>
      ...
      <div className="w-full flex justify-end md:absolute md:h-[115%]">
        ...
        <div className="w-full flex items-end h-full md:pl-8 md:bg-home-about-bg bg-cover bg-bottom bg-no-repeat md:w-1/2 ">
          <div className="relative w-[25rem] h-[25rem] -mb-40 md:w-[35rem] md:h-[35rem]">
            <Image
